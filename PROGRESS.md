...
- Working dir: `/Users/moofwd/Documents/raft` (folder named `raft`; project codename **Flotilla**, package names `@atul1104/*`).
...
### Verified
- `npm run build --workspace @atul1104/landing` ✅ (CSS 13 kB / JS 157 kB · gzip 51 kB).
